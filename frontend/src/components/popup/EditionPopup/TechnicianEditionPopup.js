                    ...
                    <div className="singleColumnPopUpContainer">
                        ...
                        <div className="gridContainer">
                            <div className="rowContainer">
                                <div className="gridItem">
                                    ...
                                    <span className="textField">
                                        <CustomTextField label={"First Name"} value={firstName} setText={setFirstName} maxLength={24} alpha={true} required={true} validate={validate} />
                                    </span>
                                </div>
                                <div className="gridItem">
                                    <span className="labelField">Last Name</span>
                                    <span className="textField">
                                        <CustomTextField label={"Last Name"} value={lastName} setText={setLastName} maxLength={32} alpha={true} required={true} validate={validate} />
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField label={"Email"} value={email} setText={setEmail} maxLength={32} email={true} disabled={true} required={true} />
                                </span>
                            </div>
                            ...
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField label={"Phone number"} value={phoneNumber} setText={setPhoneNumber} maxLength={9} minLength={9} numeric={true} required={true} validate={validate} />
                                </span>
                            </div>
                        </div>

                        <div className="buttonContainer">
                            <CustomButton className="saveButton" setTriggerButton={setTriggerButton} requestBody={createRequestBody} type={Titles.techniciansPageTitle} validate={setValidate}>
                                Update Technician
                            </CustomButton>
                        </div>
                    </div>
