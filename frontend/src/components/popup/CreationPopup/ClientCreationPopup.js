                        ...
                        <div className="gridContainer">
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField required={true} label={"Name"} setText={setName} maxLength={32} validate={validate} />
                                </span>
                            </div>
                            ...
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField required={true} label={"Email"} setText={setEmail} maxLength={32} email={true} validate={validate} />
                                </span>
                            </div>
                            ...
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField required={true} label={"Phone number"} setText={setPhoneNumber} maxLength={9} minLength={9} numeric={true} validate={validate} />
                                </span>
                            </div>
                        </div>
