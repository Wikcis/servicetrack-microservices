                    ...
                    <div className="singleColumnPopUpContainer">
                        ...
                        <div className="gridContainer">
                            <div className="rowContainer">
                                <div className="gridItem">
                                    ...
                                    <span className="textField">
                                        <CustomTextField label={"First Name"} setText={setFirstName} maxLength={24} alpha={true} required={true} validate={validate} />
                                    </span>
                                </div>
                                <div className="gridItem">
                                    <span className="labelField">Last Name</span>
                                    <span className="textField">
                                        <CustomTextField label={"Last Name"} setText={setLastName} maxLength={32} alpha={true} required={true} validate={validate} />
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField label={"Email"} setText={setEmail} maxLength={32} email={true} required={true} validate={validate} />
                                </span>
                            </div>
                            ...
                            <div className="gridItem">
                                ...
                                <span className="textField">
                                    <CustomTextField label={"Phone number"} setText={setPhoneNumber} maxLength={9} minLength={9} numeric={true} required={true} validate={validate} />
                                </span>
                            </div>
                        </div>
